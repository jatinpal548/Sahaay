...
import 'package:sahaay/screens/chatbot_screen.dart';
import 'package:sahaay/screens/study_helper_screen.dart';
import 'package:sahaay/screens/stress_patterns_screen.dart';
import 'package:sahaay/screens/todo_list_screen.dart';
import 'package:sahaay/screens/exam_routine_screen.dart';
import 'package:sahaay/screens/settings_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  void _navigateToFeature(String title, String emoji, String description) {
    ...
    // Map feature titles to their screens
    switch (title) {
      case 'Study Helper':
        targetScreen = const StudyHelperScreen();
        break;
      case 'Stress Patterns':
        targetScreen = const StressPatternsScreen();
        break;
      case 'To-Do List':
        targetScreen = const TodoListScreen();
        break;
      case 'Exam Routine Planner':
        targetScreen = const ExamRoutineScreen();
        break;
      default:
        targetScreen = PlaceholderScreen(
          title: title,
          emoji: emoji,
  ...
  void _navigateToStressCheck() {
    ...
    final currentStress = stressProvider.currentStressLevel;
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) =>
            ChatbotScreen(initialStressLevel: currentStress),
        transitionDuration: AppTheme.slowAnimation,
        transitionsBuilder: (context, animation, secondaryAnimation, child) {
          return SlideTransition(
            position: Tween<Offset>(
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Consumer<StressProvider>(
                        builder: (context, stressProvider, child) {
                          return _PrimaryStressHandler(
                            stressLevel: stressProvider.currentStressLevel,
    ...
    return Opacity(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final itemAnimation =
              ((animationValue - delay).clamp(0.0, 1.0) * (1.0 / (1.0 - delay)))
                  .clamp(0.0, 1.0);
